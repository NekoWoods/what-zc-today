...
function calculate(){
    if (remainder == 0){
        ...
        document.getElementById("rotation").innerHTML = "<b>学校</b>>火山>机关>学校>风图>机关"};
    if (remainder == 1){
        ...
        document.getElementById("rotation").innerHTML = "学校><b>火山</b>>机关>学校>风图>机关"};
    if (remainder == 2){
        ...
        document.getElementById("rotation").innerHTML = "学校>火山><b>机关</b>>学校>风图>机关"};
    if (remainder == 3){
        document.title="推车什么地图？学校", 
        document.getElementById("mainImage").src = img[1],
        document.getElementById("mainImage").alt = "你看到这行字因为图没显示出来 总之现在是学校啦！",
        document.getElementById("rotation").innerHTML = "学校>火山>机关><b>学校</b>>风图>机关"};
    if (remainder == 4){
        ...
        document.getElementById("rotation").innerHTML = "学校>火山>机关>学校><b>风图</b>>机关"};
    if (remainder == 5){
        document.title="推车什么地图？机关", 
        document.getElementById("mainImage").src = img[3],
        document.getElementById("mainImage").alt = "你看到这行字因为图没显示出来 总之现在是机关啦！",
        document.getElementById("rotation").innerHTML = "学校>火山>机关>学校>风图><b>机关</b>"};
}
calculate();
